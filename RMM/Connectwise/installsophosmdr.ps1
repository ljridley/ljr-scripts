...
#Products - Example - "antivirus,intercept,xdr,mdr" for Sophos XDR/MDR agent
$Global:CustomerToken = "enter token here"
$Global:Products = "antivirus,intercept,xdr,mdr"
...
Invoke-WebRequest -Uri "https://dzr-api-amzn-eu-west-1-9af7.api-upe.p.hmr.sophos.com/api/download/$CustomerToken/SophosSetup.exe" -OutFile SophosSetup.exe
